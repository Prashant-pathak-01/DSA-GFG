<h2><a href="https://www.geeksforgeeks.org/problems/maximum-no-of-1s-row3027/1?page=1&category=Matrix&difficulty=Easy&status=unsolved&sortBy=submissions">Maximum no of 1's row</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a boolean 2D array, where each row is sorted. Find the row with the maximum number of 1s.</span></p>
