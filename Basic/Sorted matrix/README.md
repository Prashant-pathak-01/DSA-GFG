<h2><a href="https://www.geeksforgeeks.org/problems/sorted-matrix2333/1?page=1&category=Matrix&status=unsolved&sortBy=submissions">Sorted matrix</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an NxN&nbsp;matrix Mat. Sort&nbsp;all elements of the matrix.</span></p>
